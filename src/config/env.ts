...
const schema = z.object({
  ...
  API_SECRET_ENC_KEYS: z.string().optional(),
  MAX_REQUEST_BODY_BYTES: z.coerce.number().default(1024 * 1024),
  CORS_ALLOWED_ORIGINS: z.string().optional(),
  AUDIT_LOG_PATH: z.string().optional(),
  AUDIT_HASH_KEY: z.string().optional(),
  SECURITY_CONFIG_SNAPSHOT_PATH: z.string().optional(),
...
export const ENV: Env = schema.parse({
  ...
  API_SECRET_ENC_KEYS: process.env.API_SECRET_ENC_KEYS,
  MAX_REQUEST_BODY_BYTES: process.env.MAX_REQUEST_BODY_BYTES,
  CORS_ALLOWED_ORIGINS: process.env.CORS_ALLOWED_ORIGINS,
  AUDIT_LOG_PATH: process.env.AUDIT_LOG_PATH,
  AUDIT_HASH_KEY: process.env.AUDIT_HASH_KEY,
  SECURITY_CONFIG_SNAPSHOT_PATH: process.env.SECURITY_CONFIG_SNAPSHOT_PATH,
